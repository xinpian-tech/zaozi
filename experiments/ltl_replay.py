"""Re-check the exact generated Cover on live IO, without instantiating another DUT.

The formal waveform is a proposed stimulus, not an oracle for uninitialized state
or external-device responses. Only a native, four-state SVA hit admits a sequence.
Legacy schedules without this provenance keep the strict waveform contract.
"""
import hashlib
import json
import re
...
from witness_sampling import select_cover, COVER
