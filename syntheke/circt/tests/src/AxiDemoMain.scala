...
import me.jiuyang.syntheke.tests.zaoziimpl.{clockGenModel, pllAnalogModel, simConsoleModel, traceLogModel}
...
object AxiDemoMain:
  def main(args: Array[String]): Unit =
    ...
    println(s"wrote Top.mlirbc / Top.sv / the behavioral models / four JSON exports to $dir")
