...
#table(
  ...
  [成员], [member], [附着到总线的东西：叶子设备或子总线，二者同质（@sec-attach）。],
  [子总线], [sub-bus], [作为一个成员接入父总线的总线；自带物理互连，内部对父不可见（@sec-flat-nest）。],
  ...
  [角色], [role], [成员的方向：发起者或响应者；聚合由总线承担，跨协议或跨域适配落在缝上（@sec-attach、@sec-propagation）。],
