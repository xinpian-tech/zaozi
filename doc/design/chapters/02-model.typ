...
- #term[连接结构][connection structure]　由#term[总线][bus]、附着到总线上的#term[成员][member]、以及子总线的嵌套构成（详见@ch-interconnect）。它表达*可达与协商*：谁与谁经哪条总线相通、地址如何译码、参数在何处协商。成员是设备或子总线，各自唯一从属于一个模块。
