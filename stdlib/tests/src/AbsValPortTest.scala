...
/** The DPI contract as a dependent type on AbsVal's `(IO, Probe)`: drive/probe ports resolve by name and are checked at
  ...
  */
object AbsValPortTest extends TestSuite:
