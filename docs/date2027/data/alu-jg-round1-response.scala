...
object Generated extends UTExperiment:
  def run(outDir: os.Path): ujson.Value =
    ...
    val cases = Seq(
      ("fp_add_round_carry", 0, 0x3fffffffL, 0x40000000L),
      ("fp_sub_underflow_zero", 1, 0x00800001L, 0x00800000L),
      ("fp2int_nan", 8, 0x7fc00000L, 0x00000000L),
      ("fp2int_small_zero", 8, 0x3f000000L, 0x00000000L),
      ("and_default_fp_inactive", 2, 0x00000000L, 0x00000000L),
      ("reserved_opcode_default", 10, 0x00000000L, 0x00000000L)
    )
